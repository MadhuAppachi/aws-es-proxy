...
[![Docker Pulls](https://img.shields.io/docker/pulls/MadhuAppachi/aws-es-proxy.svg)](https://hub.docker.com/r/MadhuAppachi/aws-es-proxy/)
...
Download the latest [aws-es-proxy release](https://github.com/MadhuAppachi/aws-es-proxy/releases/).
...
docker run --rm -v ~/.aws:/root/.aws -p 9200:9200 MadhuAppachi/aws-es-proxy:v1.0 -endpoint https://dummy-host.ap-southeast-2.es.amazonaws.com -listen 0.0.0.0:9200

v.08:

docker run --rm -it MadhuAppachi/aws-es-proxy ./aws-es-proxy -endpoint https://dummy-host.ap-southeast-2.es.amazonaws.com
...
```sh
#requires go1.14
go build github.com/MadhuAppachi/aws-es-proxy
```
